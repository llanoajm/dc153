        ...
        <div className={styles.footerTop}>
          <div className={styles.footerBrand}>
            <svg className={styles.footerMark} viewBox="0 0 460 393" fill="none" aria-hidden="true">
              ...
              <path d="M 386.3,189.0 C 391.1,196.1 395.0,202.3 395.0,202.7 C 395.0,203.5 369.7,220.5 368.6,220.5 C 368.3,220.5 364.0,214.4 359.0,207.1 L 350.1,193.6 L 363.3,184.8 C 370.6,180.0 376.8,176.0 377.1,176.0 C 377.4,176.0 381.6,181.8 386.3,189.0 Z" stroke="currentColor" strokeWidth="14" strokeLinejoin="round" />
            </svg>
