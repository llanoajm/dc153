    ...
    <div className={styles.page}>
      ...
      <section className={styles.hero}>
        ...
        <div className={styles.heroContent}>
          ...
          <p className={styles.heroSub}><span className={styles.step4}>Planning, de-risking, and accelerating the most</span><br /><span className={styles.step5}>critical electrical infrastructure projects</span></p>
